...
$sql = "INSERT INTO cop(cop_id,designation_id,cop_name,login_id,password,status)values('1','1','Administrator','admin','admin','Active')";
$qsql = mysqli_query($con,$sql);
...
<html lang="en">
	...
	<li>
		...
		<a href="mailto:indiancop46@gmail.com">indiancop46@gmail.com</a>
	</li>
	<li>
		<i class="fa fa-envelope"></i>
		<a href="#">Mon - Sat 8:00 - 6:30</a>
	</li>
