                ...
                <ul>
                    <li data-transition="parallaxtoright">
                        ...
                        <div class="tp-caption tp-resizeme max-style" id="slide-1-layer-1" 
                            ...
                            style="z-index: 5; white-space: nowrap; color: #fff; font-weight: 700; text-transform: uppercase;"><span>ONLINE CRIME</span> <BR><SPAN>MANAGEMENT SYSTEM</SPAN>
                            </div>
                        <!-- END LAYER 1 -->
                    ...
                    <li data-transition="parallaxtoright">
                        ...
                        <div class="tp-caption tp-resizeme max-style" id="slide-2-layer-1" 
                            ...
                            data-responsive_offset="on" 
                            data-elementdelay="0.05" 
                            style="z-index: 5; white-space: nowrap; color: #fff; font-weight: 700; text-transform: uppercase;">ONLINE CRIME<BR><SPAN>MANAGEMENT SYSTEM</SPAN>
                            </div>
                        <!-- END LAYER 1 -->
                    </li>
                    <li data-transition="parallaxtoright">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="text-section">
                            <h3 class="underline">Crime Report  <br/><span>Management System</span></h3>
                            <p class="mb30"><strong>Crime Report Management System</strong>  is a website in which will reduce the paperwork of the
