...
?>
        ...
        <!-- Start Text Section -->
        <section class="pad-t100" style="background-color: #f9f9f9;">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="template-image text-center mbl-mar-bottom">
                            <img src="assets/images/others/girl2.png" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="feature-5">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <div class="feature-text">
                                        <p>Sed porttitor lectus nibh. Pellentesque in ipsum id orci porta dapibus. Nulla quis lorem ut libero malesuada feugiat. Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="filter">
                            ...
                            <li><a href="#" data-filter=".html" class="">HTML</a></li>
                            <li><a href="#" data-filter=".wordpress" class="">WordPress</a></li>
                            <li><a href="#" data-filter=".joomla" class="">Joomla</a></li>
                        </ul>
                    </div>
                </div>
                <div class="row">
                    <div class="portfolio-box">
                        <div class="col-md-4 col-sm-6 html">
                            <div class="portfolio-post-1 mb30">
                                ...
                                <div class="portfolio-details">
                                    ...
                                    <div class="portfolio-title">
                                        ...
                                        <div class="portfolio-tags">Business</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 html wordpress">
                            <div class="portfolio-post-1 mb30">
                                <img src="assets/images/portfolio/4.jpg" alt="">
                                <div class="portfolio-details">
                                    <div class="portfolio-icon">
                                        <a class="link" href="single-project.html"><i class="icon-attachment"></i></a>
                                        <a class="zoom" href="assets/images/portfolio/4.jpg" data-lightbox="portfolio-1"><i class="icon-magnifying-glass"></i></a>
                                    </div>
                                    <div class="portfolio-title">
                                        <h4>Portfolio Title</h4>
                                        <div class="portfolio-tags">Business</div>
                        ...
                        <div class="col-md-4 col-sm-6 html joomla">
                            <div class="portfolio-post-1 mb30">
                                ...
                                <div class="portfolio-details">
                                    <div class="portfolio-icon">
                                        <a class="link" href="single-project.html"><i class="icon-attachment"></i></a>
                                        <a class="zoom" href="assets/images/portfolio/5.jpg" data-lightbox="portfolio-1"><i class="icon-magnifying-glass"></i></a>
                                    </div>
                                    <div class="portfolio-title">
                                        <h4>Portfolio Title</h4>
                                        <div class="portfolio-tags">Business</div>
                        ...
                        <div class="col-md-4 col-sm-6 wordpress joomla">
                            <div class="portfolio-post-1 mb30">
                                <img src="assets/images/portfolio/6.jpg" alt="">
                                <div class="portfolio-details">
                                    <div class="portfolio-icon">
                                        <a class="link" href="single-project.html"><i class="icon-attachment"></i></a>
                                        <a class="zoom" href="assets/images/portfolio/6.jpg" data-lightbox="portfolio-1"><i class="icon-magnifying-glass"></i></a>
                                    </div>
                                    <div class="portfolio-title">
                                        <h4>Portfolio Title</h4>
                                        <div class="portfolio-tags">Business</div>
