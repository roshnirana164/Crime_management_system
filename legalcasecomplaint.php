...
<table id="datatablefixcolumn"  class="table table-striped table-bordered">
	...
	<tbody>
		...
		{
			echo "<tr>		
					<td><br><center style='font-size: 25px;color: red;'>$rs[0]</center></td>	
					...
					<td>";
			echo "<hr><a href='legalcase.php?complaint_id=$rs[complaint_id]' class='btn btn-info' style='width: 70px;' target='_blank'>ENTER</a>";
			echo "</td></tr>";
		}
	?>
	</tbody>
